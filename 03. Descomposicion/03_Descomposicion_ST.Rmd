...
```{r}
potencia_jj <- JohnsonJohnson^(1/3)

autoplot(potencia_jj) +
  ggtitle("Logaritmo de las ventas trim. de J&J")
```
...
Si $\lambda = 1$ entonces $w_t = y_t-1$, lo que significaría que los datos solo se desplazarían hacia abajo, sin cambiar la forma de la serie de tiempo. Para cualquier otro valor de $\lambda$, la serie cambiara de forma.
