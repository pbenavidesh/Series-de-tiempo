...
```{r pkgs, message=FALSE, context="setup"}
library(tidyverse)
library(fpp3)
library(patchwork)
```
...
```{r shiny-differences, context="server"}
...
```{r shiny-us_change, context="server"}
inputPanel(
...
```{r shiny-eu_retail, context="server"}
h02_train <- h02 %>% 
